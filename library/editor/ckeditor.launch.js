...
sakai.editor.editors.ckeditor.launch = function(targetId, config, w, h) {
    ...
    (function() {
        ...
        CKEDITOR.plugins.addExternal('image2',webJars+'ckeditor-image2/4.11.1/', 'plugin.js');

        //Autosave has a dependency on notification
        CKEDITOR.plugins.addExternal('autosave',webJars+'ckeditor-autosave/0.18.1/', 'plugin.js');
        CKEDITOR.plugins.addExternal('wordcount',webJars+'wordcount/1.17.4/', 'plugin.js');
        ...
        ckconfig.extraPlugins+="sakaipreview,image2,audiorecorder,contentitem,movieplayer,wordcount,notification,autosave,bt_table";
